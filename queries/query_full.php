...
$sql_con="SELECT p.id_product, p.id_dispositive, p.id_xpu, p.id_memory, p.id_screen, p.id_battery, p.id_connectivity, p.id_extras, p.id_cat, p.product_stock, p.product_price, p.listed,
