...
if(isset($_POST['guess'])){
    ...
    $smartQuery .= "ORDER BY product_price ASC";
    ...
    if (mysqli_num_rows($sQuery)>0) {
        ...
        echo '<div class="columns is-multiline is-centered res">';
            echo '<p class="title column is-full">Nuestras recomendaciones:</p>';
        ...
        echo '<div class="columns is-multiline is-centered" style="margin: 10% auto; max-width: 60%;">';
        echo '<p class="title column is-full" style="margin-top: 5%">No encontramos ningun producto que coincida a la perfeccion con vos :c </p>';
    }
        ?>

    <p class="subtitle column is-full" style="margin-top: 5%">Hace click<a href="productos.php" class="subtitle has-text-info" > aca </a>para ver el listado de productos entero!</p>
